...
public class Redpanda extends RedpandaContainer {
  ...
  private static RedpandaContainer instance;

  public static RedpandaContainer getInstance(final Network network) {
    if (instance == null) {
      instance = new Redpanda()
        .withNetwork(network)
  ...
  public static void createTopics() {
    try {
      instance.execInContainer("sh", "-c", "rpk topic create squer-trading-prices");
